...
from quantbench.api.security import require_local_api_token
...
app = FastAPI(title="QuantBench API", lifespan=_lifespan, dependencies=[Depends(require_local_api_token)])
