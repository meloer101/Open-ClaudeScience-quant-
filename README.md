...
- Reviewer 审查引擎，自动输出未来函数、样本外衰减、手续费敏感性、funding 成本敏感性、参数稳定性、Deflated Sharpe、多重检验/PBO、walk-forward、CPCV purge/embargo、截面 IC Newey-West 显著性、regime/tail 依赖、换手率、beta 暴露、截面标的集中度和 PIT universe 覆盖率检查。
